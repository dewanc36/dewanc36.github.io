...
export const siteConfig = {
  ...
  intro: [
    "I'm a New York based software engineer who has worked across industries — building at <strong>Amazon</strong> (AWS, Amazon.com, Prime Video Search), <strong>Snapchat</strong>, and the investment bank <strong>Houlihan Lokey</strong>.",
